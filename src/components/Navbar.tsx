...
import { Menu, X, MessageSquare, Heart, PlusCircle, User } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2 flex-shrink-0">
            ...
            <span className="text-xl font-bold text-gray-900">Bytaren</span>
          </Link>
        ...
        <div className="md:hidden border-t border-gray-100 bg-white">
          <div className="px-4 py-3 space-y-1">
            <Link
              ...
              className="block px-3 py-2 text-sm font-medium text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 rounded-lg"
            >
              Hitta byte
            </Link>
            <Link
            ...
            <div className="pt-2 border-t border-gray-100">
              <Link
                href="/(auth)/logga-in"
                onClick={() => setMobileOpen(false)}
                className="block px-3 py-2 text-sm font-medium bg-emerald-600 text-white rounded-lg text-center"
              >
                Logga in
              </Link>
            </div>
